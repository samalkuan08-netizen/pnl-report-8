...
OPEX_CONCEPT={
 ...
 'сертификационные услуги':'SUBCONTRACT','сертификац':'SUBCONTRACT',
...
KEYWORD_RULES=[
 ...
 (('услуги','связ'),'INTERNET'),(('техническ','диагностик'),'SUBCONTRACT'),
 (('технические','услуг'),'SUBCONTRACT'),
 (('амортизац',),'AMORT'),(('зарплат',),'SALARY'),(('оклад',),'SALARY'),(('заработн',),'SALARY'),
 (('геодез',),'SUBCONTRACT'),(('подряд',),'SUBCONTRACT'),(('сертификац',),'SUBCONTRACT'),
